...
// Create a struct named PubSubConverter which implements the KRMToOnePlatformConverter interface from converter.go
...
func sdkToKRMObj(sdkObj *pubsub.TopicConfig, strongTypeObject *v1beta1.PubSubTopic) *v1beta1.PubSubTopic {
	...
	krmObj.TypeMeta = strongTypeObject.TypeMeta
	krmObj.ObjectMeta = strongTypeObject.ObjectMeta
